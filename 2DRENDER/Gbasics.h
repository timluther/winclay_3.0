...
class trgba:public trgbabase
{
    ...
    trgba &operator =(UINT32 val){*((UINT32*)&b)=val;return *this;}
    trgba &operator <<=(UINT8 val){r<<=val;g<<=val;b<<=val;a<<=val;return *this;}
    trgba &operator >>=(UINT8 val){r>>=val;g>>=val;b>>=val;a<<=val;return *this;}    
    UINT32 getdword(){return *(UINT32*)&b;}
    bool operator ==(trgba &other){return getdword()==other.getdword();}
    bool operator !=(trgba &other){return getdword()!=other.getdword();}
   
	UINT32 swaprgb(){swap(r,b);return getdword();}
...
class trgbaword:public trgbawordbase
{
    ...
    trgbaword &operator >>=(UINT8 val){r>>=val;g>>=val;b>>=val;a<<=val;return *this;}
	//UINT64 getqword(){return *(UINT64*)&b;}
    /*operator trgb <<(UINT8 val){trgb r;r.r=r<<val;r.g=g<<val;r.g=g<<val;return r;}    
    operator trgb >>(UINT8 val){trgb r;r.r=r>>val;r.g=g>>val;r.g=g>>val;return r;}*/
};
...
inline UINT32 SWAPRGB(UINT32 a)
{
	return (((a >> 16) & 0x000000FF)|((a << 16) & 0x00FF0000)|(a & 0xFF00FF00));
}
//#define SWAPRGB(a) (((a >> 16) & 0x0000FF00)|((a << 16) & 0xFF000000)|(a & 0x00FF00FF))
#define BUILDARGB(a,r,g,b) ((a<<24)|(r<<16)|(g<<8)|(b))
#define BUILDRGBA(r,g,b,a) ((r<<24)|(g<<16)|(b<<8)|(a))
#define BUILDBGRA(b,g,r,a) ((b<<24)|(g<<16)|(r<<8)|(a))
...
template <class T> class trecttemplate
{
	...
	T actualheight(){return 1+b.y-a.y;}
    T actualwidth(){return 1+b.x-a.x;}    
